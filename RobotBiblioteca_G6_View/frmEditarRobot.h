...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(379, 356);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(65, 356);
			...
			this->label2->Location = System::Drawing::Point(62, 71);
			...
			this->comboBox2->Location = System::Drawing::Point(214, 212);
			...
			this->comboBox1->Location = System::Drawing::Point(214, 86);
			...
			this->ClientSize = System::Drawing::Size(517, 423);
			this->Controls->Add(this->button4);
			this->Controls->Add(this->button3);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmEditarRobot";
			this->Text = L"Editar Robot";
			this->Load += gcnew System::EventHandler(this, &frmEditarRobot::frmEditarRobot_Load);
...
#pragma endregion
	private: System::Void frmEditarRobot_Load(System::Object^ sender, System::EventArgs^ e) {
	}
};
}
